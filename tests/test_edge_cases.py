    ...
    def data_with_negative_afolu(self):
        ...
        for year in [2020, 2030, 2050, 2100]:
            ...
            data.extend([
                ...
                {"model": "Test", "scenario": "Test", "region": "World",
                 "variable": "Emissions|CO2|Fossil Fuels and Industry", "unit": "Mt CO2/yr",
                 "year": year, "value": 35000},
                {"model": "Test", "scenario": "Test", "region": "World",
                 "variable": "Emissions|CO2|Industrial Processes", "unit": "Mt CO2/yr",
                 "year": year, "value": 2000},
                {"model": "Test", "scenario": "Test", "region": "World",
                 "variable": "Emissions|CO2|Carbon Capture and Storage", "unit": "Mt CO2/yr",
                 "year": year, "value": 0},
                {"model": "Test", "scenario": "Test", "region": "World",
                 "variable": "Emissions|CO2|Carbon Capture and Storage|Biomass", "unit": "Mt CO2/yr",
                 "year": year, "value": 0},
                {"model": "Test", "scenario": "Test", "region": "World",
